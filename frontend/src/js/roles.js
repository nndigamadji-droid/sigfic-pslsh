    ...
    administrateur: [
      ...
      },
      {
        ...
        items: [
          ...
          { href: '/pages/finances/journal-banque.html', icon: 'fa-piggy-bank', label: 'Journal de banque (JB)' },
          { href: '/pages/finances/journal-achats.html', icon: 'fa-shopping-cart', label: 'Journal des achats (JA)' },
          { href: '/pages/finances/journal-od.html', icon: 'fa-sliders-h', label: 'Journal des op. diverses (OD)' },
          ...
          { href: '/pages/finances/bilan.html', icon: 'fa-chart-pie', label: 'Bilan SYSCOHADA' },
          { href: '/pages/finances/resultat.html', icon: 'fa-chart-line', label: 'Compte de résultat' },
          { href: '/pages/finances/tft.html', icon: 'fa-water', label: 'Tableau des flux de trésorerie' },
          { href: '/pages/finances/rapport.html', icon: 'fa-file-invoice-dollar', label: 'Rapport financier global' },
