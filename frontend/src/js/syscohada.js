(function (window) {
  ...
  const CATALOG = [
    ...
    { code:'2184', famille:'Mobilier de bureau', sousFamille:'Postes de travail & assises',
      ...
      keywords:['bureau','table','fauteuil','siège','chaise','caisson','armoire','bibliothèque','étagère','rangement','banque accueil','sous-main','dossier suspendu','rideau','meuble'] },
    ...
    { code:'6064', famille:'Fournitures administratives', sousFamille:'Papeterie & écriture',
      ...
      keywords:['ramette','papier a4','papier a3','papier thermique','cahier','bloc','bloc-note',
